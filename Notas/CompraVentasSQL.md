...
CREATE TABLE Personal (
  ...
  TelCasa VARCHAR(15) NULL,  -- Cambiado de INT a VARCHAR(15)
...
INSERT INTO Proveedores (RFC, NomEmpresa, NombreRepresentante, ApeP_Representante, TelContacto, DiaPedido, DiaEntrega, TipoPago)
VALUES ('NUEVO987654', 'Comercializadora XYZ', 'Ana', 'García', 55998877, 'Lunes', 'Martes', 'Efectivo');
...
-- Consultar todos los campos de la vista 'V_ventasXemp' e incluir una columna de comisión del 10%
SELECT
    NumSS,
    NombreCompleto,
    NumeroVentas,
